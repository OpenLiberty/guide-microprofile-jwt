...
Open the `start/backendServices/src/main/java/io/openliberty/guides/system/SystemResource.java` file and add roles-based access control. A simple way to proceed is to copy all the following code and replace the content of the file:
...
Open the `start/backendServices/src/main/java/io/openliberty/guides/inventory/InventoryResource.java` file and add roles-based access control. A simple way to proceed is to copy all the following code and replace the content of the file:
...
Create the `start/backendServices/src/main/java/io/openliberty/guides/inventory/client/SecureSystemClient.java` file with the following code:
[source, java, indent=0]
----
