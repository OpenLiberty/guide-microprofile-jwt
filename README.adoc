...
// =================================================================================================
// Retrieving confidential information from JWT
// =================================================================================================

=== Retrieving confidential information from JWT

To demonstrate how MP-JWT retrieves confidential information from the security token, add an additional service that uses JAX-RS security related methods which map to MP-JWT features.
