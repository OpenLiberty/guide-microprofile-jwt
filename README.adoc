...
`Bearer` prepended to it and is included in the `Authorization` header of the
subsequent requests made by the [hotspot=restClient file=1]`SystemClient instance`.
