...
:page-seo-title: Securing Java microservices with MicroProfile JSON Web Token (MicroProfile JWT)
:page-seo-description: A tutorial on how to secure Java microservices to authenticate users and control access by validating JSON Web Tokens using Eclipse MicroProfile JWT.
