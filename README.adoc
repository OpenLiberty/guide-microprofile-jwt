...
the JWT was built, check out the https://github.com/eclipse/microprofile-jwt-auth/blob/master/spec/src/main/asciidoc/interoperability.asciidoc[MP-JWT documentation^]
...
You can also see the values of the `name` and `groups` claims in the rows labels
`Name:` and `Roles:`. Again, these are being read from the JWT and sent back to
