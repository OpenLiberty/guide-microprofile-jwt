...
Open the `start/backendServices/src/main/java/io/openliberty/guides/system/SystemResource.java` file and add roles-based access control. Simply copy all the following code and replace the contents of the file:
...
Open the `start/backendServices/src/main/java/io/openliberty/guides/inventory/InventoryResource.java` file and add roles-based access control. Simply copy all the following code and replace the contents of the file:
