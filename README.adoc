...
The MicroProfile JWT feature, [hotspot=29]`mpJwt`, has been added as a dependency in your [hotspot=1-261]`pom.xml` file.
...
To see whether the tests detect a failure, remove the authorization header generation in the [hotspot=24-26 file=1]`setup()` method of the [hotspot=13-64 file=1]`InventoryEndpointTest.java` file.
