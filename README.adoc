...
In the `start/backendServices/src/main/java/io/openliberty/guides/inventory/` directory, open the `InventoryResource.java` file  and add roles-based access control as shown in the following code:
...
The `getGroups()` function retrieves the user groups information from the JSON Web Token.
