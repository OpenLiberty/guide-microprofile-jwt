...
=== Securing the system service
[role="code_command hotspot=15", subs="quotes"]
----
...
=== Securing the inventory service
[role="code_command hotspot=25", subs="quotes"]
----
...
The `SecureSystemClient` class inherits methods from the `SystemClient` class. These methods hand 
