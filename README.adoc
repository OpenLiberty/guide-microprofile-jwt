...
First start your application with the `inventory` and `system` services in `dev`
...
First add the MicroProfile JWT feature to the server configuration file for both
...
of the public key to be used the validate the an incoming tokens signature. In
