...
You should now be redirected to a another page with that will display the logged in user, the current OS of your localhost and the web token that is being used by the front-end to access the data.
