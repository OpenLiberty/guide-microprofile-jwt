...
Once you log in, you can see some basic information about your current session, including the name of the user who is logged in, the role of the user, your current operating system, the size of your inventory service, and the JWT that is used for authorization.
...
After making sure that the response code is correct, each test tries to get the content from the designated endpoint and compares the result with its expected value.
