...
service. The frontend service logs a user in, builds a JWT, and makes authorized requests to
the secure `system` service for JVM system properties.

image::JWT_Diagram.png[JWT frontend system, align="center"]
