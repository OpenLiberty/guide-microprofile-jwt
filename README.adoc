...
If you log in as an `admin` user, the current OS is also shown. 
Click the `Log out` button and try another user. If you log in as
...
After you log in as an `admin` user, you can see the information that's retrieved from the `system`
service. Click the `Log out` button and try another user. 
