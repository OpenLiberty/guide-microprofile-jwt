...
// =================================================================================================
// Add the ClientCore class
// =================================================================================================

=== Add the ClientCore class

Add the class `ClientCore.java` in `/start/backendServices/src/main/java/io/openliberty/guides/inventory/client/ClientCore.java` to add code to return the auth header in the GET requests.

[source, java, indent=0]
----
include::finish/backendServices/src/main/java/io/openliberty/guides/inventory/client/ClientCore.java[tags=!copyright,!doc]
----
