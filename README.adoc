...
[role="code_command hotspot=11-33"]
----
...
The [hotspot=32]`<mpJwt>` element is required to configure the injection of the caller's JWT.
...
[role="code_command hotspot=14-33"]
----
...
=== Securing the inventory service
[role="code_command hotspot=14-65"]
----
...
[role="code_command hotspot=14-51"]
----
...
However, the `SecureSystemClient` class overrides the `buildClientBuilder()` method by adding the authorization header to the returned builder, `return builder.header(HttpHeaders.AUTHORIZATION, authHeader)`.
...
[role="code_command hotspot=14-67"]
----
...
[role="code_command hotspot=14-69"]
----
...
[role="code_command hotspot=46-58"]
----
...
----
[role="code_command hotspot=60-69"]
----
