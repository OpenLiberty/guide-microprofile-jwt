...
file=0]`/jwtRoles` endpoint. To read more about different claims and ways to access them, check out the 
...
`String authorization` parameter of this method is to be uses in the `Authorization`
