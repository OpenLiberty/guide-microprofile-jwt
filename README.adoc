...
----
Replace the `System Resource` class file with roles-based access control.
...
[role="code_command hotspot=1-52", subs="quotes"]
----
Replace the `Inventory Resource` class file with roles-based access control.
...
[role="code_command hotspot=1-38", subs="quotes"]
----
Create the `Secure System Client` class file.
...
[role="code_command hotspot=1-54", subs="quotes"]
----
Create the `JWT Resource` file to enable a service that retrieves information from the token.
...
----
Create the `System Endpoint Test` class file.
...
----
Create the `Inventory Endpoint Test` class file.
...
----
Create the `JWT Test` class file.
