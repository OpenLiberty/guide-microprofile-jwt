...
}
{
  ...
  "groups": ["admin","user"],       //Provides the list of group names that have been assigned to the principal of the MP-JWT
  "iss": "http://openliberty.io",   //The token issuer
  "exp": 1520453327,                //Identifies the expiration time on or after which the JWT MUST NOT be accepted for processing
