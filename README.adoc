...
If you wish to manually access the claims of the JWT, perhaps to provide more granual access control, MicroProfile JWT provides
you with get style accessors.
