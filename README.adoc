...
Next, navigate out of the `frontend` directory and into the `inventory` directory. Run the following goal:
...
You are redirected to a page that displays some information. The current OS is
...
in the request. If you log in as an `admin` user, the current inventory size
appears and can add systems to this inventory using the interface below. If you
log in as a `user`, you instead see the message, `You are not authorized to
...
// =================================================================================================
// Configuring the MicroProfile JWT
// =================================================================================================


Navigate to the `start` directory 

First start your application with the `inventory` and `system` services running in `dev`
mode. Execute the following command from the `frontend` directory to run a script
that starts that starts the frontend module in the background.
...
headers specified in in the MicroProfile Config property:
...
Specify the `Authorization` header for the `org.eclipse.microprofile.rest.client.propagateHeaders`
MicroProfile Config property for the inventory service. 
