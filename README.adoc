...
To try out the application, run the following commands to navigate to the `finish/system` directory and
...
Open another command-line session and run the following commands to navigate to the `finish/frontend` directory and
deploy the `system` service to Open Liberty:
