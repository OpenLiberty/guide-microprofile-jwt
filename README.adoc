...
You can also see that the [hotspot=aud file=2]`aud()` method is being used to set the `aud` claim of the token. 
This claim is used to specify the audience that the JWT is intended for. 
// =================================================================================================
